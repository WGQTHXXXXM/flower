$(function(){	
$.getJSON("/Passport/loginState?rmd="+Math.random(), function(json){    //登陆信息显示
		...
		var loginedHtml='<p class="avatar_imgbox"><img src="http://img02.hua.com/pc/assets/img/mbar/avatar_none.jpg"></p>你好！请 <a href="'+loginUrl+'">登录</a> | <a href="/Passport/Register/">注册</a>';
		if(json.Logined==true)
		{
			loginedHtml='<p class="avatar_imgbox"><img src="http://img02.hua.com/pc/assets/img/mbar/avatar.jpg"></p><a href="/Member/MemberCenter/">'+json.ShowName+'</a>，你好！'
			if(json.IsVip==true)
			{
				loginedHtml=loginedHtml+'<i class="ico_vip"></i>'
			}
			loginInfo='<a href="/Member/MemberCenter/" rel="nofollow">你好，'+json.ShowName+'</a><a href="/Passport/Logout" title="退出">退出</a>';
		}
...
$.getJSON("/shopping/getcartjson?rmd="+Math.random(), function(json){    //购物车信息显示
	...
	jQuery(function($){
		...
		showQuickPop = function(type){
			$(".quick_links_wrap,.mui-mbar-tabs").width(318);
			...
			if(type !== prevPopType){
				...
				else if(type=="history_list")
				{
					$.getJSON("/Home/getAttentionJson?rmd="+Math.random(), function(json){
						...
						if(json.productsNum==0)
						{
							cartHtml='<div class="ibar_plugin_content"><div class="sub_title">你还没有关注的商品！</div></div>'
						}
						else
						{
							cartHtml='<div class="ibar_plugin_content"><div class="sub_title">共关注了 '+json.productsNum+' 件商品</div>'
							$.each(json.datas,function(index,data){
